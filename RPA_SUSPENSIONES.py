...
from utils.ots import lista_ots, lista_ots_no_activas, observacion, ot_anulada, suspension_admin, excepcion_observa, subir_estado, lista_ots_sin_hacer_tarea, grabar_logs
...
async def run_playwright_for_nrolote(nrolote, user, password):
    ...
    lista_ots_sin_hacer_tarea(nrolote, 1)
    ...
    async def process_ot(ot, sem, pw):
        async with sem:
            ...
            try:
                ...
                await loop.run_in_executor(None, grabar_logs, f'Cambiando la fecha de ejecucion final de la OT {ot}', nrolote, ot)
